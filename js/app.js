...
.constant("SongLibrary", [
		...
		},
		{
			...
			surface: "http://p4.music.126.net/S8p3CjMOSnbzPphm2meQdg==/2404631929969272.jpg?param=130y130"
		},
		{
			id: 3,
			name: "大きな世界",
			...
			surface: "http://p1.music.126.net/o5eiuV6ICCydRLimgxXpuQ==/925788790612394.jpg?param=130y130"
		},
		{
			id: 4,
			name: "光るなら",
			author: "Goose house (グースハウス)",
			url: $h.home() + "/song/library-4.mp3",
			//surface: $h.home() + "/image/surface-4.jpg"
			surface: "http://p1.music.126.net/TM6SM2-ppcd1F66YyjR-Eg==/2537672838610591.jpg?param=130y130"
		},
		{
			id: 5,
			name: "TOMORROW",
			author: "甲田雅人",
			url: $h.home() + "/song/library-5.mp3",
			//surface: $h.home() + "/image/surface-5.jpg"
			surface: "http://p3.music.126.net/K9JspNhWALNYoKgMczT5ww==/18720284976418411.jpg?param=177y177"
		},
		{
			id: 6,
			name: "ちいさな冒険者",
			...
			surface: "http://p3.music.126.net/sB9Dgytsw36PHYgB8Nxq1Q==/3386495816508708.jpg?param=177y177"
		},
		{
			id: 7,
			...
			surface: "http://p3.music.126.net/uj0jS9Qnc2cirRl6q0SK1A==/1418370000157194.jpg?param=130y130"
		},
		{
			id: 8,
			name: "ピースサイン",
			...
			surface: "http://p4.music.126.net/5oit8dbUPU1CauY_9Nkggw==/19000660439703907.jpg?param=130y130"
		},
		{
			id: 9,
			name: "HEROES",
			...
			surface: "http://p1.music.126.net/rnjvBG_wP8oNitMRLhywiA==/3433774815522737.jpg?param=130y130"
		},
		{
			id: 10,
			name: "茜さす",
			...
			surface: "http://p3.music.126.net/imIdf78bmtZwduGmMNiCYQ==/18779658602840072.jpg?param=130y130"
		},
		{
			id: 11,
			name: "六等星の夜",
			...
			surface: "http://p3.music.126.net/O0EE48Uv5cDxBLf2_Lkn6w==/1376588569408912.jpg?param=130y130"
		},
		{
			id: 12,
			name: "雨音ノイズ",
			...
			surface: "http://p3.music.126.net/H40ys2e027zTrNP8Jnmsxw==/18817041999595817.jpg?param=130y130"
		}
	]
)
